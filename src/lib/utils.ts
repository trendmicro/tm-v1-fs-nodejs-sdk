...
const AWS_ID_REGION = 'ap-southeast-3'
...
*/
const V1Regions = [AWS_AU_REGION, AWS_DE_REGION, AWS_JP_REGION, AWS_SG_REGION, AWS_US_REGION, AWS_IN_REGION, AWS_AE_REGION, AWS_GB_REGION, AWS_CA_REGION, AWS_ZA_REGION, AWS_ID_REGION]
